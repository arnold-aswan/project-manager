...
const MyTasks = () => {
	...
	const filteredTasks =
		myTasks?.filter((task) => {
			...
			const matchesFilter =
				filter === "all" ||
				(filter === "todo" && normalizedStatus === "to do") ||
				(filter === "inprogress" && normalizedStatus === "in progress") ||
				(filter === "done" && normalizedStatus === "done") ||
				(filter === "achieved" && task.isArchived === true) ||
				(filter === "high" && normalizedPriority === "high");
